...
The serving API must not import ``carepath.gec.*`` (research/serving stay
...
and the enriched datastore, so a server only needs the bundle directory.
    ...
    python scripts/gec/export_serve.py \
...
from carepath.gec.config import DEFAULT_BASE_MODEL, FALLBACK_BASE_MODEL  # noqa: E402
from carepath.gec.prompts import IM_END, IM_START, SYSTEM_PROMPT  # noqa: E402
...
def main() -> None:
    ...
    manifest = {
        ...
        # dependency on carepath.gec.prompts.
        "prompt": {
