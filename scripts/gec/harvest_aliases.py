...
GEC prompt. Run after the pairs exist (real + labeled + synthetic).
    ...
    python scripts/gec/harvest_aliases.py \
...
from carepath.gec.data import read_jsonl, write_jsonl  # noqa: E402
from carepath.gec.harvest import enrich_datastore  # noqa: E402
