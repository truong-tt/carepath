"""CLI: QLoRA fine-tune a DARAG GEC adapter, optionally per ablation variant (paper §5).
    ...
    python scripts/gec/train.py --pairs ... --output-dir artifacts/gec_lora/qwen3 --all-variants
"""
...
from carepath.gec.config import DEFAULT_BASE_MODEL, FALLBACK_BASE_MODEL, VARIANTS  # noqa: E402
from carepath.gec.train import TrainArgs, train  # noqa: E402
