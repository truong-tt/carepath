...
export const strings: Record<Language, PageCopy> = {
  vi: {
    ...
    scribeTool: {
      ...
      copy: "Sao chép bản nháp",
      copied: "Đã sao chép bản nháp",
      copyFailed: "Không sao chép được",
      newNote: "Tạo bản nháp mới",
